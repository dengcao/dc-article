...
class comment
{
    protected $cmt_config = [
        "cache_time" => 7200,//评论列表缓存时间，0为不启用缓存，缓存单位：秒，比如缓存1小时可设置：3600
        "cmt_pagesize" => 5,//每页显示评论数量
        "cmt_hot" => 0,//显示热门评论数量，为0时不显示热门评论
        "is_captcha" => true,//评论是否启用验证码
        "is_check" => true,//评论是否需要审核
        "is_face" => true,//评论是否启用聊天表情
        "is_img" => false,//评论是否允许发图片
        "is_br" => true,//评论内容是否转换换行符
        "is_like" => true,//评论是否可以点赞
        "is_bad" => true,//评论是否可以踩
        "is_reply" => true,//评论是否可以回复
        "is_scroll_load" => 0,//是否滚动加载评论，1为滚动加载，0为不滚动加载
